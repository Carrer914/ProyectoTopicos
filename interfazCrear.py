from PyQt5.QtWidgets import QMainWindow, QLabel, QVBoxLayout, QPushButton, QWidget, QLineEdit, QGridLayout, QMessageBox
from conexion_db import conectar_db
from PyQt5.QtCore import Qt
import mysql.connector
from validar_crear import validar_cedula, validar_telefono
...
class VentanaRegistroProfesor(QMainWindow):
    ...
    def insertar_profesor(self):
        ...
        if not validar_cedula(cedula, self):
            return

        if not validar_telefono(telefono, self):
            return
